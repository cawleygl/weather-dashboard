...
function currentWeather() {
    ...
    $.ajax({
        ...
        temp.text("Temperature: " + tempF + "°F");
				...
				//Create and append temperature range list item
				var range = $("<li>");
        weatherInfo.append(range);
        var tempMax = response.main.temp_max.toFixed(1);
        var tempMin = response.main.temp_min.toFixed(1);
        range.text("Range: " + tempMin + "°F - " + tempMax + "°F");
        ...
        $.ajax({
            ...
            for (i = 1; i < 6; i++) {
                ...
                forecastHumid.text(response.list[i].main.humidity + "% Humidity");
            }
